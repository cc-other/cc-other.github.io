...
var lianstr = "红绿蓝兰金木水火土牛虎兔龙蛇马羊猴鸡狗猪鼠大小单双";
//统计码数
function countma()
{
    ...
    if(inputstr.length >0 )
    {
        ...
        //
		document.getElementById("resultstxt").innerHTML=tongji(allmastr);
...
function countstyle(tjstylestr)
{
    ...
    if(inputstr.length >0 )
    {
        ...
        for(var i=0;i< cinumarr.length;i++)
        {
            ...
            cistr += '（共'+ geshu +'个）<br/><br/>' ;
            tjstr += cistr ;            
        }
        tjstr += "<br/>";
		document.getElementById("resultstxt").innerHTML=tjstr;
